...
print('ticTacToe')
server_process = subprocess.Popen(['./start_server', '../rbgGames/games/ticTacToe.rbg', '7982', '--deadline', '100','--first_move_deadline','10', '--log_results', results_logging_filename], stdout=subprocess.PIPE)

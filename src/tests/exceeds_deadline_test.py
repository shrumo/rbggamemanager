...
print('ticTacToe')
server_process = subprocess.Popen(['./start_server', '../rbgGames/games/ticTacToe.rbg', '7982', '--deadline', '100', '--log_results', results_logging_filename], stdout=subprocess.PIPE)

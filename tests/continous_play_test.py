...
print('TicTacToe')
server_process = subprocess.Popen(['./start_server', '../extern/rbgGames/games/ticTacToe.rbg', '7981', '--log_results', results_logging_filename, '--shutdown', '1000.0'], stdout=subprocess.PIPE)
